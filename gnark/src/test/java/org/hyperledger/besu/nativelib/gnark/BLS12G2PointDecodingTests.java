...
public class BLS12G2PointDecodingTests {
  ...
  public void testG2IsOnCurve_ValidPoint() {
    ...
    boolean result = LibGnarkEIP2537.isG2OnCurve(input, input.length);
  ...
  public void testG2IsOnCurve_InvalidPoint() {
    ...
    int result = LibGnarkEIP2537.eip2537G2IsOnCurve(input, input.length);

    assertThat(result).isEqualTo(LibGnarkEIP2537.EIP2537_ERR_CODE_POINT_ON_CURVE_CHECK_FAILED);
  }
  ...
  public void testG2IsOnCurve_InvalidPadding() {
    ...
    assertThat(result).isEqualTo(LibGnarkEIP2537.EIP2537_ERR_CODE_MALFORMED_POINT_PADDING);
  }
  ...
  public void testG2IsOnCurve_InvalidLength() {
    ...
    assertThat(result).isEqualTo(LibGnarkEIP2537.EIP2537_ERR_CODE_INVALID_INPUT_LENGTH);
  }
  ...
  public void testG2IsInSubGroup_ValidPoint() {
    ...
    boolean result = LibGnarkEIP2537.isG2InSubGroup(input, input.length);
  ...
  public void testG2IsInSubGroup_NotInSubGroup() {
    ...
    int result = LibGnarkEIP2537.eip2537G2IsInSubGroup(input, input.length);

    assertThat(result).isEqualTo(LibGnarkEIP2537.EIP2537_ERR_CODE_POINT_IN_SUBGROUP_CHECK_FAILED);
  }

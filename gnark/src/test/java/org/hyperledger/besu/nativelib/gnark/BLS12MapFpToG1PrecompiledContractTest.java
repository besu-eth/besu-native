...
public class BLS12MapFpToG1PrecompiledContractTest {
  ...
  public void shouldCalculate() {
    ...
    final byte[] output = new byte[LibGnarkEIP2537.EIP2537_PREALLOCATE_FOR_G1];

    int errorCode =
        LibGnarkEIP2537.eip2537_perform_operation(
            LibGnarkEIP2537.BLS12_MAP_FP_TO_G1_OPERATION_SHIM_VALUE, input, input.length, output);
